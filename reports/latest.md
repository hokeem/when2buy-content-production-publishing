...
- 状态更新：`2026-09-13T15:01:05.199670+00:00`
- X 账号：`@_When2buy`
- 对标帖子快照：**669**
- 待选选题：**591**
- 待发布制作包：**0**
...
- `2026-09-13T14:46:27Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
- `2026-09-13T14:46:05Z` **full / partial** — Reconciled Postiz and completed preflight, but the required Apify scan was blocked before fresh benchmark collection. Apify returned platform-feature-disabled: Monthly usage hard limit exceeded for @WhaleInsider; no source substitution, backlog publish, or retry was performed.
- `2026-09-13T14:45:44Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
- `2026-09-13T14:31:42Z` **full / blocked** — Freshness-first run stopped safely because Apify collection was unavailable; no new benchmark state, package, or publication was created. Apify returned HTTP 403 platform-feature-disabled: monthly usage hard limit exceeded.
- `2026-09-13T14:31:07Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
- `2026-09-13T14:30:28Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
- `2026-09-13T00:00:00Z` **full / blocked** — Freshness-first run stopped before collection or publication because Apify rejected the benchmark scan. Apify API returned HTTP 403 platform-feature-disabled: Monthly usage hard limit exceeded. No new source data was captured; no package was submitted.
...
- `2026-09-13T13:46:18Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
- `2026-09-13T13:31:40Z` **full / partial** — Preflight, Postiz reconciliation, Apify discovery attempt, benchmark-media archive pass, package reconciliation, hard-TTL queue rebuild, and first-hour metrics completed; no fresh item was processed. Apify HTTP 403 platform-feature-disabled: monthly usage hard limit exceeded; no publication attempted. Recoverable on the next scheduled run.
- `2026-09-13T13:31:29Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
- `2026-09-13T13:16:19Z` **full / partial** — Preflight, Postiz reconciliation, Apify discovery attempt, existing-media archive pass, package reconciliation, and hard-TTL queue rebuild completed; no fresh item was processed because Apify returned a provider usage-limit error. Apify HTTP 403 platform-feature-disabled: monthly usage hard limit exceeded; no publication attempted.
- `2026-09-13T13:15:58Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
