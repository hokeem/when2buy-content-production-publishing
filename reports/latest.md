...
- 状态更新：`2026-09-13T21:16:26.145936+00:00`
- X 账号：`@_When2buy`
- 对标帖子快照：**669**
- 待选选题：**591**
- 待发布制作包：**0**
...
| 5 | NEW: @NBCNews covers SolCex Exchange and its upcoming stock trading launch, with stocks sche… | WhaleInsider | 20377 | Newest eligible unpinned benchmark signal; if caption and media conflict, keep this topic and use the narrowest accurate wording instead of skipping to an older post. |
...
### S&P 500 on pace for fourth straight red day
...
### SemiAnalysis acquires Citrini Research
...
### Fed hike odds surge to 81%

- 状态：`published`
- 配图：`deliverables/pkg-20260912-fed-hike-odds-81/when2buy-image.png`
...
| Oracle just reported earnings | 2026-09-10T20:19:00.000Z | 92 | 0 | 0 | 0 | [X](https://x.com/_When2buy/status/2098144463050944775) |
...
| Ford faces fresh scrutiny over China partnerships | 2026-09-09T05:51:00.000Z | 50 | 1 | 0 | 1 | [X](https://x.com/_When2buy/status/2097563734508245248) |
| Oracle AI backlog reaches $664B | 2026-09-10T20:35:00.000Z | 50 | 0 | 0 | 0 | [X](https://x.com/_When2buy/status/2098148490069344673) |
...
| Ryan Cohen buys $20.4M of GameStop stock | 2026-09-10T23:17:00.000Z | 46 | 0 | 0 | 0 | [X](https://x.com/_When2buy/status/2098189298495570024) |
...
| Pentagon in talks to lend roughly $5B to Fluidstack | 2026-09-10T22:02:00.000Z | 31 | 0 | 0 | 0 | [X](https://x.com/_When2buy/status/2098170354678341984) |
...
| NVIDIA CEO calls cybersecurity the next major AI use case | 2026-09-10T16:20:00.000Z | 27 | 0 | 0 | 0 | [X](https://x.com/_When2buy/status/2098084400001105925) |
...
| Isar Aerospace reaches orbit from western Europe | 2026-09-08T01:48:00.000Z | 11 | 0 | 0 | 0 | [X](https://x.com/_When2buy/status/2097139963221708976) |
...
| Whole Foods store workers average more than $21 an hour | 2026-09-10T17:48:00.000Z | 10 | 0 | 0 | 0 | [X](https://x.com/_When2buy/status/2098106569653473354) |
...
| Hassett says inflation is decelerating | 2026-09-11T14:33:00.000Z | 8 | 0 | 0 | 0 | [X](https://x.com/_When2buy/status/2098419869192753392) |
...
- `2026-09-13T21:16:26Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
- `2026-09-13T21:16:19Z` **full / partial** — Preflight, state validation, Postiz reconciliation, and queue rebuild completed; required Apify benchmark collection was blocked before any source or package write. Apify returned HTTP 403 platform-feature-disabled: Monthly usage hard limit exceeded while collecting @WhaleInsider. No publication attempted; next scheduled run should retry collection after the external limit is restored.
- `2026-09-13T21:15:40Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
- `2026-09-13T21:01:03Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
- `2026-09-13T21:00:57Z` **full / partial** — Preflight, state validation, Postiz reconciliation, and queue rebuild completed; required Apify benchmark collection was blocked before any source or package write. Apify returned HTTP 403 platform-feature-disabled: Monthly usage hard limit exceeded while collecting @WhaleInsider. No publication attempted; next scheduled run should retry collection after the external limit is restored.
- `2026-09-13T21:00:27Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
- `2026-09-13T20:46:24Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
- `2026-09-13T20:46:18Z` **full / partial** — Preflight, state validation, Postiz reconciliation, and queue rebuild completed; required Apify benchmark collection was blocked before any source or package write. Apify returned HTTP 403 platform-feature-disabled: Monthly usage hard limit exceeded while collecting @WhaleInsider. No publication attempted; next scheduled run should retry collection after the external limit is restored.
- `2026-09-13T20:45:58Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
- `2026-09-13T20:31:58Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
- `2026-09-13T20:31:25Z` **full / blocked** — Freshness run stopped before discovery because Apify rejected both-feed collection with provider usage limit. Apify HTTP 403 platform-feature-disabled: Monthly usage hard limit exceeded; no publish attempted.
- `2026-09-13T20:30:40Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
- `2026-09-13T20:16:34Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
- `2026-09-13T20:16:21Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
- `2026-09-13T20:16:15Z` **full / partial** — Preflight, state validation, Postiz reconciliation, and queue rebuild completed; required Apify benchmark collection was blocked before any source or package write. Apify returned HTTP 403 platform-feature-disabled: Monthly usage hard limit exceeded while collecting @WhaleInsider. No publication attempted; next scheduled run should retry collection after the external limit is restored.
- `2026-09-13T20:15:38Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
- `2026-09-13T20:01:27Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
- `2026-09-13T20:01:20Z` **full / partial** — Preflight, state validation, Postiz reconciliation, and queue rebuild completed; required Apify benchmark collection was blocked before any source or package write. Apify returned HTTP 403 platform-feature-disabled: Monthly usage hard limit exceeded while collecting @WhaleInsider. No publication attempted; next scheduled run should retry collection after the external limit is restored.
- `2026-09-13T19:46:36Z` **full / partial** — Preflight, state validation, Postiz reconciliation, hourly metrics, media archival, package reconciliation, and hard-TTL queue rebuild completed; no fresh candidate was processed. Apify collection blocked by HTTP 403 platform-feature-disabled: Monthly usage hard limit exceeded while collecting @WhaleInsider. No publication attempted; next scheduled run should retry collection after the external limit is restored.
- `2026-09-13T19:46:03Z` **queue / succeeded** — Prepared 0 fresh candidate(s); expired 0 unsent stale package(s).
