...
def main():
    ...
    out = f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>WHEN2BUY X CONTENT FACTORY</title><style>
      :root{{--ink:#f8f7f7;--muted:#a5a0a2;--red:#ec2638;--red-soft:rgba(236,38,56,.15);--glass:rgba(22,20,22,.72);--line:rgba(255,255,255,.12);--shadow:0 24px 64px rgba(0,0,0,.36)}}*{{box-sizing:border-box}}body{{margin:0;min-height:100vh;color:var(--ink);background:radial-gradient(circle at 8% -8%,#491019 0,transparent 30rem),radial-gradient(circle at 100% 2%,#241015 0,transparent 28rem),linear-gradient(135deg,#080809 0%,#111012 55%,#070708 100%);font:14px/1.55 ui-sans-serif,system-ui,-apple-system,"Segoe UI",sans-serif}}body:before{{content:"";position:fixed;inset:0;pointer-events:none;background:linear-gradient(120deg,rgba(255,255,255,.025),transparent 35%,rgba(236,38,56,.035));z-index:-1}}main{{max-width:1660px;margin:auto;padding:42px 24px 72px}}.masthead{{display:flex;align-items:center;gap:18px;margin:0 0 36px;padding:20px 22px;border:1px solid var(--line);border-radius:20px;background:linear-gradient(135deg,rgba(255,255,255,.075),rgba(255,255,255,.025));box-shadow:var(--shadow);backdrop-filter:blur(18px)}}.brand-logo{{width:58px;height:58px;object-fit:contain;border-radius:14px;background:#000;border:1px solid rgba(236,38,56,.55);padding:5px}}h1{{margin:0;font-size:clamp(30px,4vw,54px);line-height:.98;letter-spacing:-.055em;font-weight:850;text-wrap:balance}}.eyebrow{{margin:6px 0 0;color:var(--muted);font-size:12px;letter-spacing:.12em;text-transform:uppercase}}h2{{margin:0 0 12px;font-size:15px;letter-spacing:.1em;text-transform:uppercase;color:#f3e9eb}}a{{color:#ff6573;text-decoration:none}}a:hover{{color:#fff;text-decoration:underline}}.muted{{color:var(--muted)}}.day-card{{margin-top:28px;padding:18px;border:1px solid var(--line);border-radius:18px;background:var(--glass);box-shadow:var(--shadow);backdrop-filter:blur(18px)}}.table-wrap{{overflow:auto;border:1px solid var(--line);border-radius:12px}}table{{width:100%;min-width:1120px;border-collapse:collapse;background:rgba(7,7,8,.38)}}th,td{{padding:16px;vertical-align:top;text-align:left;border-bottom:1px solid rgba(255,255,255,.08)}}tbody tr:last-child td{{border-bottom:0}}tbody tr{{transition:background .18s ease}}tbody tr:hover{{background:rgba(255,255,255,.035)}}th{{font-size:11px;letter-spacing:.1em;text-transform:uppercase;color:#bbb3b6;background:rgba(255,255,255,.045)}}td:first-child{{white-space:nowrap;color:var(--muted);width:165px}}td:nth-child(2){{width:31%}}td:nth-child(3){{width:35%}}.source-images{{display:flex;gap:8px;flex-wrap:wrap;margin-top:10px}}.source-image{{width:84px;height:84px;object-fit:cover;border-radius:8px;border:1px solid var(--line)}}.final-image{{display:block;width:172px;height:172px;object-fit:cover;border-radius:10px;border:1px solid rgba(236,38,56,.42);margin-top:12px;box-shadow:0 10px 24px rgba(0,0,0,.3)}}.copy{{max-width:540px}}.release-inline{{display:flex;align-items:center;gap:9px;flex-wrap:wrap;margin-top:12px}}.status{{display:inline-block;padding:3px 8px;border-radius:999px;font-size:10px;font-weight:850;letter-spacing:.08em}}.published{{background:var(--red-soft);color:#ff8993;border:1px solid rgba(236,38,56,.35)}}.pending{{background:rgba(255,255,255,.08);color:#d0cbcd}}.tracking-cell{{min-width:292px;font-size:12px}}.tracking-values{{display:flex;gap:5px;flex-wrap:wrap}}.metric-chip{{display:inline-flex;align-items:center;gap:4px;padding:4px 6px;border:1px solid rgba(255,255,255,.12);border-radius:7px;background:rgba(255,255,255,.045);white-space:nowrap}}.metric-icon{{color:#ff5a69;font-size:13px;line-height:1}}.metric-label{{font-size:10px;letter-spacing:.025em;color:var(--muted)}}.metric-chip strong{{font-size:12px;color:#fff}}.tracking-meta{{color:var(--muted);margin-top:8px;font-size:11px}}.tracking-state{{color:#ff8a95;font-weight:800;letter-spacing:.04em}}.snapshots{{margin:7px 0;padding-left:18px;color:var(--muted);font-size:11px}}.metric-details{{margin-top:8px;border-top:1px solid rgba(255,255,255,.1);padding-top:7px}}.metric-details summary{{cursor:pointer;color:#ff8792;font-weight:750}}@media(max-width:700px){{main{{padding:20px 12px 44px}}.masthead{{padding:15px;gap:12px;border-radius:15px;margin-bottom:22px}}.brand-logo{{width:43px;height:43px;border-radius:10px}}h1{{font-size:31px}}.eyebrow{{font-size:10px;letter-spacing:.08em}}.day-card{{margin-top:18px;padding:10px;border-radius:14px}}.table-wrap{{overflow:visible;border:0}}table{{min-width:0;background:transparent}}thead{{display:none}}tbody,tr,td{{display:block;width:100%!important}}tbody tr{{padding:12px 0;border-bottom:1px solid rgba(255,255,255,.12)}}tbody tr:last-child{{border-bottom:0}}td{{padding:8px 2px;border:0}}td:before{{content:attr(data-label);display:block;margin-bottom:4px;color:#aaa1a5;font-size:10px;font-weight:800;letter-spacing:.09em;text-transform:uppercase}}td:first-child{{white-space:normal}}.final-image{{width:148px;height:148px}}.source-image{{width:72px;height:72px}}.tracking-cell{{min-width:0}}}}
    </style></head><body><main><header class="masthead"><img class="brand-logo" src="{e(LOGO_URL)}" alt="when2buy logo"><div><h1>WHEN2BUY X CONTENT FACTORY</h1><p class="eyebrow">Daily source-to-release ledger · Postiz API-first metrics</p></div></header>{''.join(sections) or '<p class="muted">No source posts captured.</p>'}</main></body></html>'''
